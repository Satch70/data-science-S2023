...
-   How much do you trust your model? Why?
    -   The rsquare for both of the values is close to 0.7. So it is not a bad model for the error percentage. But enough of the points fall within the pi for me to be more confident about its accuracy for making sure the variables recommended in this model would work.
