...
-   What *Category* of variable is `avg_T`? Why is it such an effective predictor?
    -   avg_T is so great at predicting t_norm because it is in the equation of T_norm and the other inputs aren't in the equation.
...
-   Which model tends to be more accurate? How can you tell from this predicted-vs-actual plot?
    -   the q4 model is more accurate. The trend line follows the data points more.
...
-   How much do you trust your model? Why?
    -   The rsquare for both of the values is close to 0.7. So it is not a bad model for the error percentage. But enough of the points fall within the pi for me to be more confident about its accuracy for making sure the variables recommended in this model would work. This also means that the pi could be much smaller and therefor be more accurate.
-   What kind of interval---confidence or prediction---would you use for this task, and why?
    -   pi because I want to make sure that the outputs fall within the predicted output since I am testing for a specific heat.
...
-   Are there any other recommendations you would provide?
    -   I would recommend isolating more inputs that have a measurable affect on the accuracy of the prediction. Finding inputs that not only have a measurable affect, but are also easy to manage. For example the fluid density. It was an input that had a great affect on accuracy, and is also easy to manage by finding a fluid with an ideal density. So, finding more controllable inputs would allow the prediction to be more accurate. I also think that this would narrow down the pi so that it would be a more accurate and helpful reading.
