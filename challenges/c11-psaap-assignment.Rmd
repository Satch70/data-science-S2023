...
-   Are there any other recommendations you would provide?
    -   I think that input is also important to manage because that is a variable that humans can control and it is a variable that greatly affected the accuracy of the prediction. So, controlling that would allow the prediction to be more accurate. I also think that this would narrow down the pi so that it would be a more accurate and helpful reading.
