...
- we can observe that there are cases where diamonds with lower carat are worth a higher price
...
- adding color shows that the quality of the cut also effects the price the diamonds are sold at
- there is a general trend where lower quality cuts are worth less than the higher quality cut counter parts
