...
- a general upward trend can be observed
- as carat quality increases, the overall price also increases
- there are outliers to this statement
- we can observe that there are cases where diamonds with lower carat
...
- we can observe that there are cases where diamonds with lower carat
  are worth a higher price
- we now are given more insight into why this is true
- adding color shows that the quality of the cut also effects the price
  the diamonds are sold at
- there is a general trend where lower quality cuts are worth less than
  the higher quality cut counter parts
