...
-   Was your sample size $n$ large enough? Why do you say that?
    -   100,000 was large enough. Pi lies within the range of the interval, and the range was not ridiculously large where every point would most likely fall within it because it was just so big. We also know that this range is good because the error was also relatively small.
