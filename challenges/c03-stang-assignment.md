...
- Is there “one true value” for the material properties of Aluminum?
  - No there is not one true value for the properties of aluminum. There
...
- What thicknesses were tested?
  - 0.022, 0.032, 0.064, 0.081 - not sure what metric they are measuring
    in.
...
- According to the graph, the thickness does not effect the elasticity
  that much for the thickness values of 0.022, 0.032, 0.064 but we can
  see an increase in elasticity with a thickness of 0.081. I don’t
  believe this difference is big enough to make the claim that thickness
  actually affects the elasticity of the alloy.
...
- Does this graph support or contradict the claim above?
  - We can see by noticing that the thickness value of 0.081 does not
    group close to the other three thickness values. Like above I don’t
    believe that the difference in measurement is enough to make the
    claim that thickness effects the elasticity of the alloy.
