...
if cursor on function name pull up the help page for the function

	* `Cmd/Ctrl` + `Shift` + `C`
comment and uncomment current kine
...
By pressing the red square in the top right corner

### __q4__ How do you show the "Document Outline" in RStudio?

*Hint*: Try googling "rstudio document outline"

In RStudio, the "Document Outline" can be displayed by clicking on the "Show Document Outline" button in the "Source" pane, or by using the keyboard shortcut Ctrl+Shift+O (Cmd+Shift+O on macOS). The Document Outline provides a hierarchical view of the structure of the R script, including sections, functions, and chunks of code.
<!-- include-exit-ticket -->
# Exit Ticket
<!-- -------------------------------------------------- -->
