...
Since airpot is assigned a value with type string, the == operator can't check if ATL matches since ATL has not been assigned a value yet. ATL is an object so we can't compare and unassigned object to the value of a current one.
