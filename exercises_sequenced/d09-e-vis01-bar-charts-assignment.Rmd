...
**Observations**: - Write your observations here! Suv is the most common
2seater is the least.
...
**Observations**: - Write your observations here! 4 wheel drive is the
most common. there are no minivan or 2seaters that have 4wheel - as well
as showing us the most common cars
...
**Observations** - Your observations here! the graph shows how many of
each car class each manufacturer makes. It also shows which
manufacturers make the most amount of cars.

### **q5** The following graph is hard to read. What other form of faceting would
