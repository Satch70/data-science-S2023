...
### **q1** Use a `cut_*` verb to create a categorical variable out of `carat`. Tweak
...
diamonds %>%
  ...
  mutate(carat_cut = cut_interval(carat, n = 10)) %>% 
...
Price rises as carat rises. The median price dramatically rises from 0 -
2 and then levels out.
...
Yes the most common is premium I.
