...
General trend of higher carat = higher price
many diamonds of same carat are sold for varying prices
...
- (Write your observations here!)
This shows how most of the cuts can dictate how diamonds with the same carat can have varying prices. Generally Ideal cuts get a higher price.
