...
### **q1** Compute the mean of $2 Z + 3$, where $Z$ is a standard normal.
...
### **q2** Compute the mean of $2 Z_1 + 3 Z_2$, where $Z_1, Z_2$ are separate standard normals.
...
### **q3** Compute the variance of $2 Z + 3$, where $Z$ is a standard normal.
...
### **q4** Compute the variance of $2 Z_1 + 3 Z_2$, where $Z_1, Z_2$ are *uncorrelated* standard normals.
...
### **q5** Compute the mean and variance of $(X - 1) / 2$, where
...
### **q6** Compute the mean and variance of $1 + 2 Z$, where $Z$ is a standard normal.
...
### **q7** (Bonus) Use the identity above to prove that
...
is called the *standard error of the mean*; more generally the *standard error* for a statistic is the standard deviation of its sampling distribution. We'll return to this concept in `e-stat06`.
